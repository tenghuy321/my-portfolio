...
import Img2 from "../assets/images/Project1/image-2.png"
import Img3 from "../assets/images/Project1/image-3.png"
const Project = () => {
        ...
        <div className='w-full h-full flex flex-col justify-center'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 my-10 lg:mt-10 lg:mb-0 mr-0 md:mr-4'>
                            ...
                            <div className="bg-[#d9bb59] px-6 py-3 rounded-lg border border-black shadow-lg overflow-y-auto text-center w-full max-w-7xl max-h-[90vh]">
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 text-start py-10 gap-10">
                                        ...
                                        <div className=" md:col-span-3 bg-[#d9bb59] border border-red-500 py-2 w-full h-full rounded-[10px] text-[14px] md:text-[16px]">
                                            <div className='flex flex-col space-y-2 justify-center ml-6 w-full h-full'>
                                                <div>
                                                    <p className=''>Link</p>
                                                    <a href='https://shalom-solutions.vercel.app/' className='font-[700]'>shalom-solutions.vercel.app</a>
                                                </div>
                                                <div>
                                    ...
                                    <form action="" className='relative grid grid-cols-1 md:grid-cols-2 gap-10 text-start'>
                                        <div className='text-[20px] md:text-[25px] mt-4'>
                                            ...
                                            <input type="text" placeholder='Your name' className='mt-4 border border-b-2 border-l-0 border-r-0 border-t-0 border-black text-[#000] w-full text-[16px] bg-transparent outline-none' />
                                        </div>
                                        <div className='text-[20px] md:text-[25px] mt-4'>
                                            <label htmlFor="name">Email</label>
                                            <input type="text" placeholder='Your e-mail' className='mt-4 border border-b-2 border-l-0 border-r-0 border-t-0 border-black text-[#000] w-full text-[16px] bg-transparent outline-none' />
                                        </div>
                                        <div className='text-[20px] md:text-[25px] mt-4 md:col-span-2'>
                                            <label htmlFor="name">Service</label>
                                            <input type="text" placeholder='Your service' className='mt-4 border border-b-2 border-l-0 border-r-0 border-t-0 border-black text-[#000] w-full text-[16px] bg-transparent outline-none' />
                                        </div>
                                        <div className='text-[20px] md:text-[25px] mt-4 md:col-span-2'>
                                            <label htmlFor="name">Message</label>
                                            <textarea name="message" id="message" placeholder='Your message' className='mt-4 border border-b-2 border-l-0 border-r-0 border-t-0 border-black text-[#000] w-full text-[16px] bg-transparent outline-none'></textarea>
                                        </div>
                                    </form>
                ...
                <div className='w-full h-[200px] xl:h-[350px] relative group'>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 text-start py-10 gap-10">
                                        ...
                                        <div className=" md:col-span-3 bg-[#d9bb59] border border-red-500 py-2 w-full h-full rounded-[10px] text-[14px] md:text-[16px]">
                                            <div className='flex flex-col space-y-2 justify-center ml-6 w-full h-full'>
                                                <div>
                                                    <p className=''>Link</p>
                                                    <a href='https://everex-app.vercel.app/' className='font-[700]'>everex-app.vercel.app</a>
                                                </div>
                                                <div>
                                                    <p className=''>Category</p>
                                                    <h1 className='font-[700]'>User Experience</h1>
                    ...
                    <img src={Img2} alt="" className="w-full h-full relative z-50 object-cover object-center" />
                </div>
                <div className='w-full h-[200px] xl:h-[350px] relative group'>
                    <div className='absolute w-full h-full z-10 border border-black transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:rotate-2'></div>
                    <div className='absolute w-full h-full z-10 border border-black transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:-rotate-2'></div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 text-start py-10 gap-10">
                                        ...
                                        <div className=" md:col-span-3 bg-[#d9bb59] border border-red-500 py-2 w-full h-full rounded-[10px] text-[14px] md:text-[16px]">
                                            <div className='flex flex-col space-y-2 justify-center ml-6 w-full h-full'>
                                                <div>
                                                    <p className=''>Link</p>
                                                    <a href='https://xin-yaun-li.vercel.app/' className='font-[700]'>xin-yaun-li.vercel.app</a>
                                                </div>
                                                <div>
                                                    <p className=''>Category</p>
                                                    <h1 className='font-[700]'>User Experience</h1>
                    ...
                    <img src={Img3} alt="" className="w-full h-full relative z-50 object-cover object-center" />
                </div>
            </div>
        </div>
    )
